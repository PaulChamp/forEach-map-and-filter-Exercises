...
// let thisYear = new Date().getFullYear(); // get this year
...
function showResults(res) {
    ...
    for (let i = 0; i < getNumArticles(); i++) {  //loops thru articles however many times number is inputted
        ...
        //appends the articles to the body of the HTML
...
function runApi() {
    ...
    let urlAPI = "https://api.nytimes.com/svc/search/v2/articlesearch.json?" + $.param(apiParam);
    $.ajax({
        url: urlAPI,
        method: "GET",
